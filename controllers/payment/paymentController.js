...
const stripe = require('stripe')('sk_test_51ODijACqzYsiCOJFfogOihUkQjhlFBvs7nJfgLamkeRMrkcTs8TYdUVA4VHzihDTIOuNuV2duNrW1tzD5WPV1AR600XALPp0IL')
class paymentController {
    ...
    withdrowal_request = async (req, res) => {
        ...
        try {
            ...
            responseReturn(res, 200, { withdrowal, message: 'Withdraw request send' })
        } catch (error) {
            responseReturn(res, 500, { message: 'Internal server error' })
        }
    }
